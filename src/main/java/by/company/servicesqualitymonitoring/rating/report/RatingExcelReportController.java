...
@RestController
@RequestMapping("/rating/xls")
public class RatingExcelReportController {

    public final ReportService<Object> exelService;
    ...
    public ResponseEntity<Resource> getCompanyRating(
        ...
        Resource resource = exelService.generate(companyRatingConverter.convert(ratings), title);
    ...
    public ResponseEntity<Resource> getAverageRating(
        ...
        Resource resource = exelService.generate(averageRatingsConverter.convert(results), title);
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + title)
                .contentLength(resource.contentLength())
                .contentType(MediaType.APPLICATION_OCTET_STREAM)
    ...
    public ResponseEntity<Resource> getPeopleCount() throws IOException {
        ...
        Resource resource = exelService.generate(peopleCountConverter.convert(peopleCounts), title);
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + title)
                .contentLength(resource.contentLength())
                .contentType(MediaType.APPLICATION_OCTET_STREAM)
    ...
    public ResponseEntity<Resource> getPeopleSatisfied(@RequestBody(required = false)
        ...
        Resource resource = exelService.generate(peopleSatisfiedConverter.convert(peopleSatisfied), title);
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + title)
                .contentLength(resource.contentLength())
                .contentType(MediaType.APPLICATION_OCTET_STREAM)
    ...
    public ResponseEntity<Resource> getDynamics(
        ...
        Resource resource = exelService.generate(dynamicsConverter.convert(dynamics), title);
        return ResponseEntity.ok()
                .header(HttpHeaders.CONTENT_DISPOSITION, "attachment; filename=" + title)
                .contentLength(resource.contentLength())
                .contentType(MediaType.APPLICATION_OCTET_STREAM)
